	...
	<div>
		...
		<form action="professorUpdate.do" method="post">
			<input type="hidden" id="profId" name="profId"
				value=${professors.profId }>
			<table class="table table-hover">
				<tr>
					<th width="100">교수 이름</th>
					<td width="100"><input type="text" id="profName"
						name="profName" value=${professors.profName }></td>
				</tr>


				<tr>
					<th width="100">비밀번호</th>
					<td width="100"><input type="text" id="profPassword"
						name="profPassword"></td>
				</tr>


				<tr>
					<th width="100">전화번호</th>
					<td width="100"><input type="number" id="profPhone"
						name="profPhone" value="${professors.profPhone}"></td>
				</tr>
